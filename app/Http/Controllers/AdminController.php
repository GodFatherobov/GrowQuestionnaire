...
class AdminController extends Controller
{
    ...
    function Test(){
        ...
        //OthersQ3
        question::create([
            'Question'=>'一名團隊成員對於最近分配給他的一項常規專案頗有疑慮；過去領導者通常讓他單獨完成此類專案，他以往的績效表現和人際關係一直都很好。',
            'Option1'=>'就新專案給予詳細的指導，並允許他提出需要澄清的問題。',
            'Option2'=>'給予所需資源和權力，並在需要時適當監控。',
            'Option3'=>'將新工作拆解成一個個詳細的步驟，並向他說明。',
            'Option4'=>'討論他的疑慮，提供支持和鼓勵。',
        ...
        //OthersQ4
        question::create([
            'Question'=>'一名團隊成員提出她想要執行的一個改變；她很有熱情，並在該領域獲得諸多成就。該領導者認為她的提議非常有價值。',
            'Option1'=>'讓她參與發展此改變計劃，同時持續鼓勵她。',
            'Option2'=>'指導她如何執行此改變。',
            'Option3'=>'仔細傾聽，提出需要澄清的問題，並讓她負責執行。',
            'Option4'=>'聽取她的建議，解釋此改變會如何對她的角色產生影響，並告訴她如何執行此改變。',
        ...
        //OthersQ6
        question::create([
            'Question'=>'基於前任主管對於該團隊成員的回饋，新任領導者始終密切監督並指引該團隊成員執行這項重要任務。她已經有值得讚許的回應，而現在該領導者希望幫助她變得更有效率。',
            'Option1'=>'與她討論提升效率的想法，並鼓勵她更有效率地工作。',
            'Option2'=>'繼續密切監控並指導她的工作。',
            'Option3'=>'給她冒險的自由，以變得更有效率。',
            'Option4'=>'解釋工作效率為何重要，同時繼續提供指導和支持。',
        ...
        //OthersQ7
        question::create([
            'Question'=>'該領導者正在考慮改變工作流程，領導者將這項工作分配給熟知工作流程的一名團隊成員。該成員表達擔心自己的工作量太大，可能會導致此任務出錯。',
            'Option1'=>'明確定義改變的流程，並仔細監督實施過程。',
            'Option2'=>'與團隊成員一起討論他擔心的問題，提供支持並表達對他的能力充滿信心。',
            'Option3'=>'傾聽他的疑慮，向他解釋為何新的流程可行，並在實施新流程時加以控制。',
            'Option4'=>'給予團隊成員執行新流程所需的權力及資源。',
        ...
        //OthersQ8
        question::create([
            'Question'=>'一名團隊成員的績效表現出色，與同事關係融洽；但如果讓她獨立負責一個重要專案，該領導者還是感覺有些顧慮。',
            'Option1'=>'定期詢問專案的進展，並繼續觀察她的績效表現。',
            'Option2'=>'當領導者要做出必要決策時，詢問她的意見。',
            'Option3'=>'以界定清楚的方式循序漸進地指導她完成工作。',
            'Option4'=>'稱讚她的工作，並讓她參與專案的決策。',
            'S1'=>3,
            'S2'=>1,
        ...
        //OthersQ9
        question::create([
            'Question'=>'該領導者被指派領導一個任務小組。組內的一名成員問題較多；他似乎不清楚任務小組的目標，而且只是偶爾出席既定行程的會議。從領導者的觀察來看，他出席會議時就像是參加社交聚會，而他的行為正在影響其他成員。',
            'Option1'=>'觀察任務小組的行為，並允許他們自己解決問題。',
            'Option2'=>'詢問他的建議，但要確保任務小組達成目標。',
            'Option3'=>'建立對於該員工明確的目標和期望，並與其溝通。',
            'Option4'=>'鼓勵該團隊成員提出看法，並肯定他所做出的任何正面貢獻。',
        ...
        //OthersQ11
        question::create([
            'Question'=>'該領導者將一項任務分配給一名以前曾經做過此任務、並達到期望標準的團隊成員。過去，該領導者讓她獨立完成，但是現在她希望得到領導者的建議和參與。',
            'Option1'=>'詳細指導她如何完成此任務。',
            'Option2'=>'讓她參與決策，向她保證會提供支持，並在合適的時候給予回饋。',
            'Option3'=>'與她討論如何充分利用她過去的績效表現，然後給予她如何完成此項工作的詳細指導。',
            'Option4'=>'繼續讓她獨立完成工作。',
        ...
        question::create([
            ...
            'Option2'=>' 繼續觀察該團隊成員的行為，但讓他自行解決與其他團隊成員的意見分歧。',
            'Option3'=>'迅速而堅定地採取措施，讓團隊達成一致共識。',
            'Option4'=>'與該團隊成員探討意見分歧的狀況，並讓他知道領導者對他的支持。',
            'S1'=>1,
            'S2'=>3,
            'S3'=>0,
            'S4'=>2,
